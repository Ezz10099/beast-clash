...
- `npm run evidence` runs all 8 builds across 25 seeds with real damage, verifies one deterministic replay per build, grades runtime integrity, survivability, dominance, pacing, and the compact visual-choice schema, then writes CI-uploaded reports.
