(function () {
  ...
  const PROTOCOL = Object.freeze({
    ...
    ar: Object.freeze({
      label: "Arabic",
      neutral: "العب هذه اللعبة كما لو أنك وجدتها بنفسك. لن أشرحها لك، ويمكنك التوقف متى شئت.",
      retry: "يمكنك أن تحاول مرة أخرى إن أردت.",
      questions: Object.freeze([
        "ماذا فهمت أنه ينبغي عليك فعله؟",
        "ماذا يغيّر كلٌّ من الشكل والجوهر والقانون؟ لا بأس إن كانت إجابتك: لا أعرف.",
        "صف اختيارًا واحدًا قمت به: ماذا توقعت أن يحدث، وماذا تغيّر بعده؟",
        "ما أكثر لحظة استمتعت بها؟ وما أقل لحظة استمتعت بها أو شعرت فيها بالملل؟",
        "هل كان هناك شيء غير واضح، أو صعب الملاحظة، أو غير عادل؟",
        "هل ستختار بدء محاولة أخرى الآن، من دون مكافأة مقابل مساعدتنا؟ لماذا؟",
        "ماذا تتوقع أو تأمل أن تكتشف بعد ذلك؟",
        "ما الذي تحتاجه النسخة المكتملة كي تستحق، برأيك، تنزيلها والاحتفاظ بها؟",
      ]),
    }),
  });
  ...
  function renderQuestions() {
    ...
    PROTOCOL[language].questions.forEach(function (question, index) {
      ...
      answer.placeholder = language === "ar" ? "دوّن كلمات اللاعب كما قالها" : "Record the player's own words";
